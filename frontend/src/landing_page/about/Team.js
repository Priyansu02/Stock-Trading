            ...
            <div className='row'>
                ...
                <div className=' row p5 border-top mt-5 text-muted' style={{lineHeight:"1.8", fontSize:"1.2rem"}}>
                    ...
                    <div className='col-6 mt-5 '>
                       <p>Priyansu bootstrapped and founded TradeNova in 2026 to overcome the hurdles he faced during his decade long stint as a trader. Today, TradeNova has changed the landscape of the Indian broking industry.</p>
